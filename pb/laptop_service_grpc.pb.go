...
type LaptopServiceClient interface {
	CreateLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (*CreeateLaptopResponse, error)
...
func (c *laptopServiceClient) CreateLaptop(ctx context.Context, in *CreateLaptopRequest, opts ...grpc.CallOption) (*CreeateLaptopResponse, error) {
	out := new(CreeateLaptopResponse)
	err := c.cc.Invoke(ctx, "/duynvh.pcbook.LaptopService/CreateLaptop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *laptopServiceClient) SearchLaptop(ctx context.Context, in *SearchLaptopRequest, opts ...grpc.CallOption) (LaptopService_SearchLaptopClient, error) {
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[0], "/duynvh.pcbook.LaptopService/SearchLaptop", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *laptopServiceClient) UploadImage(ctx context.Context, opts ...grpc.CallOption) (LaptopService_UploadImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[1], "/duynvh.pcbook.LaptopService/UploadImage", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *laptopServiceClient) RateLaptop(ctx context.Context, opts ...grpc.CallOption) (LaptopService_RateLaptopClient, error) {
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[2], "/duynvh.pcbook.LaptopService/RateLaptop", opts...)
	if err != nil {
		return nil, err
	}
...
type LaptopServiceServer interface {
	CreateLaptop(context.Context, *CreateLaptopRequest) (*CreeateLaptopResponse, error)
...
func (UnimplementedLaptopServiceServer) CreateLaptop(context.Context, *CreateLaptopRequest) (*CreeateLaptopResponse, error) {
...
func _LaptopService_CreateLaptop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/duynvh.pcbook.LaptopService/CreateLaptop",
	}
...
var LaptopService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "duynvh.pcbook.LaptopService",
