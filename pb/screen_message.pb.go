...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=duynvh.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x20, 0x2e, 0x64, 0x75, 0x79, 0x6e, 0x76, 0x68, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: duynvh.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: duynvh.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: duynvh.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: duynvh.pcbook.Screen.resolution:type_name -> duynvh.pcbook.Screen.Resolution
	0, // 1: duynvh.pcbook.Screen.panel:type_name -> duynvh.pcbook.Screen.Panel
